...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MappingElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cQualifiedNameParserRuleCall_3 = (RuleCall)cGroup.eContents().get(3);
		...
		private final Keyword cRequestKeyword_7_0_0 = (Keyword)cGroup_7_0.eContents().get(0);
		private final Assignment cReferenciaEntidadAssignment_7_0_1 = (Assignment)cGroup_7_0.eContents().get(1);
		private final CrossReference cReferenciaEntidadEntidadCrossReference_7_0_1_0 = (CrossReference)cReferenciaEntidadAssignment_7_0_1.eContents().get(0);
		private final RuleCall cReferenciaEntidadEntidadIDTerminalRuleCall_7_0_1_0_1 = (RuleCall)cReferenciaEntidadEntidadCrossReference_7_0_1_0.eContents().get(1);
		private final RuleCall cQualifiedNameParserRuleCall_7_0_2 = (RuleCall)cGroup_7_0.eContents().get(2);
		private final Assignment cDatoprimitivoAssignment_7_1 = (Assignment)cAlternatives_7.eContents().get(1);
		private final RuleCall cDatoprimitivoDatoPrimitivoParserRuleCall_7_1_0 = (RuleCall)cDatoprimitivoAssignment_7_1.eContents().get(0);
		...
		//*/ Mapping:
		//	'{parameter' EQUAL servicio=[ServicioRest] QualifiedName ',' 'value' EQUAL ('request->' referenciaEntidad=[Entidad]
		//	QualifiedName | datoprimitivo=DatoPrimitivo) '}';
		@Override public ParserRule getRule() { return rule; }
		...
		//'request->' referenciaEntidad=[Entidad] QualifiedName | datoprimitivo=DatoPrimitivo
		public Alternatives getAlternatives_7() { return cAlternatives_7; }
		
		//'request->' referenciaEntidad=[Entidad] QualifiedName
		public Group getGroup_7_0() { return cGroup_7_0; }
		
		//'request->'
		public Keyword getRequestKeyword_7_0_0() { return cRequestKeyword_7_0_0; }
		
		//referenciaEntidad=[Entidad]
		public Assignment getReferenciaEntidadAssignment_7_0_1() { return cReferenciaEntidadAssignment_7_0_1; }
		
		//[Entidad]
		public CrossReference getReferenciaEntidadEntidadCrossReference_7_0_1_0() { return cReferenciaEntidadEntidadCrossReference_7_0_1_0; }
		
		//ID
		public RuleCall getReferenciaEntidadEntidadIDTerminalRuleCall_7_0_1_0_1() { return cReferenciaEntidadEntidadIDTerminalRuleCall_7_0_1_0_1; }
		
		//QualifiedName
		public RuleCall getQualifiedNameParserRuleCall_7_0_2() { return cQualifiedNameParserRuleCall_7_0_2; }
		
		//datoprimitivo=DatoPrimitivo
		public Assignment getDatoprimitivoAssignment_7_1() { return cDatoprimitivoAssignment_7_1; }
		
		//DatoPrimitivo
		public RuleCall getDatoprimitivoDatoPrimitivoParserRuleCall_7_1_0() { return cDatoprimitivoDatoPrimitivoParserRuleCall_7_1_0; }
	...
	public class AsercionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cEntidadAssignment_0_2_1 = (Assignment)cGroup_0_2.eContents().get(1);
		private final CrossReference cEntidadEntidadCrossReference_0_2_1_0 = (CrossReference)cEntidadAssignment_0_2_1.eContents().get(0);
		private final RuleCall cEntidadEntidadIDTerminalRuleCall_0_2_1_0_1 = (RuleCall)cEntidadEntidadCrossReference_0_2_1_0.eContents().get(1);
		private final RuleCall cQualifiedNameParserRuleCall_0_2_2 = (RuleCall)cGroup_0_2.eContents().get(2);
		...
		private final Assignment cServicioAssignment_2_1_1 = (Assignment)cGroup_2_1.eContents().get(1);
		private final CrossReference cServicioServicioRestCrossReference_2_1_1_0 = (CrossReference)cServicioAssignment_2_1_1.eContents().get(0);
		private final RuleCall cServicioServicioRestIDTerminalRuleCall_2_1_1_0_1 = (RuleCall)cServicioServicioRestCrossReference_2_1_1_0.eContents().get(1);
		private final RuleCall cQualifiedNameParserRuleCall_2_1_2 = (RuleCall)cGroup_2_1.eContents().get(2);
		private final RuleCall cSEMICOLONTerminalRuleCall_3 = (RuleCall)cGroup.eContents().get(3);
		...
		//*/ Asercion:
		//	('response.status' | 'response' | 'response->' entidad=[Entidad] QualifiedName) operador=Operador
		//	(elementoPrimitivo2=DatoPrimitivo | 'parameter.' servicio=[ServicioRest] QualifiedName) SEMICOLON;
		@Override public ParserRule getRule() { return rule; }
		...
		//'response.status' | 'response' | 'response->' entidad=[Entidad] QualifiedName
		...
		//'response->' entidad=[Entidad] QualifiedName
		...
		//entidad=[Entidad]
		public Assignment getEntidadAssignment_0_2_1() { return cEntidadAssignment_0_2_1; }
		
		//[Entidad]
		public CrossReference getEntidadEntidadCrossReference_0_2_1_0() { return cEntidadEntidadCrossReference_0_2_1_0; }
		
		//ID
		public RuleCall getEntidadEntidadIDTerminalRuleCall_0_2_1_0_1() { return cEntidadEntidadIDTerminalRuleCall_0_2_1_0_1; }
		
		//QualifiedName
		public RuleCall getQualifiedNameParserRuleCall_0_2_2() { return cQualifiedNameParserRuleCall_0_2_2; }
		...
		//elementoPrimitivo2=DatoPrimitivo | 'parameter.' servicio=[ServicioRest] QualifiedName
		...
		//'parameter.' servicio=[ServicioRest] QualifiedName
		...
		//servicio=[ServicioRest]
		public Assignment getServicioAssignment_2_1_1() { return cServicioAssignment_2_1_1; }
		
		//[ServicioRest]
		public CrossReference getServicioServicioRestCrossReference_2_1_1_0() { return cServicioServicioRestCrossReference_2_1_1_0; }
		
		//ID
		public RuleCall getServicioServicioRestIDTerminalRuleCall_2_1_1_0_1() { return cServicioServicioRestIDTerminalRuleCall_2_1_1_0_1; }
		
		//QualifiedName
		public RuleCall getQualifiedNameParserRuleCall_2_1_2() { return cQualifiedNameParserRuleCall_2_1_2; }
	...
	public class OperadorElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Operador");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final EnumLiteralDeclaration cIgualEnumLiteralDeclaration_0 = (EnumLiteralDeclaration)cAlternatives.eContents().get(0);
		private final Keyword cIgualEqualsSignEqualsSignKeyword_0_0 = (Keyword)cIgualEnumLiteralDeclaration_0.eContents().get(0);
		private final EnumLiteralDeclaration cMayorEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cMayorGreaterThanSignKeyword_1_0 = (Keyword)cMayorEnumLiteralDeclaration_1.eContents().get(0);
		private final EnumLiteralDeclaration cMenorEnumLiteralDeclaration_2 = (EnumLiteralDeclaration)cAlternatives.eContents().get(2);
		private final Keyword cMenorLessThanSignKeyword_2_0 = (Keyword)cMenorEnumLiteralDeclaration_2.eContents().get(0);
		private final EnumLiteralDeclaration cMayorIgualEnumLiteralDeclaration_3 = (EnumLiteralDeclaration)cAlternatives.eContents().get(3);
		private final Keyword cMayorIgualGreaterThanSignEqualsSignKeyword_3_0 = (Keyword)cMayorIgualEnumLiteralDeclaration_3.eContents().get(0);
		private final EnumLiteralDeclaration cMenorIgualEnumLiteralDeclaration_4 = (EnumLiteralDeclaration)cAlternatives.eContents().get(4);
		private final Keyword cMenorIgualLessThanSignEqualsSignKeyword_4_0 = (Keyword)cMenorIgualEnumLiteralDeclaration_4.eContents().get(0);
		...
		//Igual='=='
		public EnumLiteralDeclaration getIgualEnumLiteralDeclaration_0() { return cIgualEnumLiteralDeclaration_0; }
		
		//'=='
		public Keyword getIgualEqualsSignEqualsSignKeyword_0_0() { return cIgualEqualsSignEqualsSignKeyword_0_0; }
		
		//Mayor='>'
		public EnumLiteralDeclaration getMayorEnumLiteralDeclaration_1() { return cMayorEnumLiteralDeclaration_1; }
		
		//'>'
		public Keyword getMayorGreaterThanSignKeyword_1_0() { return cMayorGreaterThanSignKeyword_1_0; }
		
		//Menor='<'
		public EnumLiteralDeclaration getMenorEnumLiteralDeclaration_2() { return cMenorEnumLiteralDeclaration_2; }
		
		//'<'
		public Keyword getMenorLessThanSignKeyword_2_0() { return cMenorLessThanSignKeyword_2_0; }
		
		//MayorIgual='>='
		public EnumLiteralDeclaration getMayorIgualEnumLiteralDeclaration_3() { return cMayorIgualEnumLiteralDeclaration_3; }
		
		//'>='
		public Keyword getMayorIgualGreaterThanSignEqualsSignKeyword_3_0() { return cMayorIgualGreaterThanSignEqualsSignKeyword_3_0; }
		
		//MenorIgual='<='
		public EnumLiteralDeclaration getMenorIgualEnumLiteralDeclaration_4() { return cMenorIgualEnumLiteralDeclaration_4; }
		
		//'<='
		public Keyword getMenorIgualLessThanSignEqualsSignKeyword_4_0() { return cMenorIgualLessThanSignEqualsSignKeyword_4_0; }
	}
