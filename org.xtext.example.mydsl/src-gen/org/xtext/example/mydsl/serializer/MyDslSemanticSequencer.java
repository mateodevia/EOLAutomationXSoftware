...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (entidad=[Entidad|ID]? operador=Operador (elementoPrimitivo2=DatoPrimitivo | servicio=[ServicioRest|ID]))
	 */
	 ...
	 *
	 * Constraint:
	 *     (servicio=[ServicioRest|ID] (referenciaEntidad=[Entidad|ID] | datoprimitivo=DatoPrimitivo))
	 */
