 ...
 * </p>
 * <ul>
 *   <li>{@link xSoftware.impl.StatusImpl#getValor <em>Valor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatusImpl extends MinimalEObjectImpl.Container implements Status {
	...
	protected EClass eStaticClass() {
		return XSoftwarePackage.Literals.STATUS;
	}
	...
	public void setValor(int newValor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XSoftwarePackage.STATUS__VALOR, oldValor, valor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XSoftwarePackage.STATUS__VALOR:
				return getValor();
		}
