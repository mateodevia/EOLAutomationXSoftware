		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMappingAccess().getGroup_8_0(), "rule__Mapping__Group_8_0__0");
					...
					put(grammarAccess.getMappingAccess().getParametroAssignment_4(), "rule__Mapping__ParametroAssignment_4");
