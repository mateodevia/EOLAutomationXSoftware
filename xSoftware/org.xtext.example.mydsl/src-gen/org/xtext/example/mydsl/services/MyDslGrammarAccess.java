...
public class MyDslGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ServicioRestElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cUrlUrlParserRuleCall_5_0 = (RuleCall)cUrlAssignment_5.eContents().get(0);
		private final RuleCall cSEMICOLONTerminalRuleCall_6 = (RuleCall)cGroup.eContents().get(6);
		private final Assignment cRequestAssignment_7 = (Assignment)cGroup.eContents().get(7);
		private final RuleCall cRequestRequestParserRuleCall_7_0 = (RuleCall)cRequestAssignment_7.eContents().get(0);
		...
		//metodo=TipoMetodoRest name=EString '{' 'URL' EQUAL url=Url SEMICOLON request=Request? response=Response '}'
		public Group getGroup() { return cGroup; }
		...
		//Url
		public RuleCall getUrlUrlParserRuleCall_5_0() { return cUrlUrlParserRuleCall_5_0; }
		
		//SEMICOLON
		public RuleCall getSEMICOLONTerminalRuleCall_6() { return cSEMICOLONTerminalRuleCall_6; }
		
		//request=Request?
		public Assignment getRequestAssignment_7() { return cRequestAssignment_7; }
		
		//Request
		public RuleCall getRequestRequestParserRuleCall_7_0() { return cRequestRequestParserRuleCall_7_0; }
	...
	public class UrlElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Url");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cUrlAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cUrlexpresionsAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cUrlexpresionsUrlExpresionParserRuleCall_1_0 = (RuleCall)cUrlexpresionsAssignment_1.eContents().get(0);
		
		//Url:
		//	{Url} urlexpresions+=UrlExpresion+;
		@Override public ParserRule getRule() { return rule; }
		...
		public Assignment getUrlexpresionsAssignment_1() { return cUrlexpresionsAssignment_1; }
		
		//UrlExpresion
		public RuleCall getUrlexpresionsUrlExpresionParserRuleCall_1_0() { return cUrlexpresionsUrlExpresionParserRuleCall_1_0; }
	}
	public class UrlExpresionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.UrlExpresion");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class MappingElements extends AbstractParserRuleElementFinder {
		...
		private final CrossReference cParametroParametroCrossReference_2_0 = (CrossReference)cParametroAssignment_2.eContents().get(0);
		private final RuleCall cParametroParametroQualifiedNameParserRuleCall_2_0_1 = (RuleCall)cParametroParametroCrossReference_2_0.eContents().get(1);
		private final Keyword cCommaKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Keyword cValueKeyword_4 = (Keyword)cGroup.eContents().get(4);
		private final RuleCall cEQUALTerminalRuleCall_5 = (RuleCall)cGroup.eContents().get(5);
		private final Alternatives cAlternatives_6 = (Alternatives)cGroup.eContents().get(6);
		private final Group cGroup_6_0 = (Group)cAlternatives_6.eContents().get(0);
		private final Keyword cRequestKeyword_6_0_0 = (Keyword)cGroup_6_0.eContents().get(0);
		private final Assignment cAtributoAssignment_6_0_1 = (Assignment)cGroup_6_0.eContents().get(1);
		private final CrossReference cAtributoAtributoCrossReference_6_0_1_0 = (CrossReference)cAtributoAssignment_6_0_1.eContents().get(0);
		private final RuleCall cAtributoAtributoQualifiedNameParserRuleCall_6_0_1_0_1 = (RuleCall)cAtributoAtributoCrossReference_6_0_1_0.eContents().get(1);
		private final Assignment cDatoprimitivoAssignment_6_1 = (Assignment)cAlternatives_6.eContents().get(1);
		private final RuleCall cDatoprimitivoDatoPrimitivoParserRuleCall_6_1_0 = (RuleCall)cDatoprimitivoAssignment_6_1.eContents().get(0);
		private final Keyword cRightCurlyBracketKeyword_7 = (Keyword)cGroup.eContents().get(7);
		...
		//*/ Mapping:
		//	'{parameter' EQUAL parametro=[Parametro|QualifiedName] ',' 'value' EQUAL ('request->'
		//	atributo=[Atributo|QualifiedName] | datoprimitivo=DatoPrimitivo) '}';
		@Override public ParserRule getRule() { return rule; }
		
		//'{parameter' EQUAL parametro=[Parametro|QualifiedName] ',' 'value' EQUAL ('request->' atributo=[Atributo|QualifiedName]
		...
		public CrossReference getParametroParametroCrossReference_2_0() { return cParametroParametroCrossReference_2_0; }
		
		//QualifiedName
		public RuleCall getParametroParametroQualifiedNameParserRuleCall_2_0_1() { return cParametroParametroQualifiedNameParserRuleCall_2_0_1; }
		...
		//'request->' atributo=[Atributo|QualifiedName] | datoprimitivo=DatoPrimitivo
		public Alternatives getAlternatives_6() { return cAlternatives_6; }
		
		//'request->' atributo=[Atributo|QualifiedName]
		public Group getGroup_6_0() { return cGroup_6_0; }
		
		//'request->'
		public Keyword getRequestKeyword_6_0_0() { return cRequestKeyword_6_0_0; }
		
		//atributo=[Atributo|QualifiedName]
		public Assignment getAtributoAssignment_6_0_1() { return cAtributoAssignment_6_0_1; }
		
		//[Atributo|QualifiedName]
		public CrossReference getAtributoAtributoCrossReference_6_0_1_0() { return cAtributoAtributoCrossReference_6_0_1_0; }
		
		//QualifiedName
		public RuleCall getAtributoAtributoQualifiedNameParserRuleCall_6_0_1_0_1() { return cAtributoAtributoQualifiedNameParserRuleCall_6_0_1_0_1; }
		
		//datoprimitivo=DatoPrimitivo
		public Assignment getDatoprimitivoAssignment_6_1() { return cDatoprimitivoAssignment_6_1; }
		
		//DatoPrimitivo
		public RuleCall getDatoprimitivoDatoPrimitivoParserRuleCall_6_1_0() { return cDatoprimitivoDatoPrimitivoParserRuleCall_6_1_0; }
	...
	private final UrlExpresionElements pUrlExpresion;
	...
	public MyDslGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pUrlExpresion = new UrlExpresionElements();
	...
	//UrlExpresion:
	//	StringType | Parametro;
	public UrlExpresionElements getUrlExpresionAccess() {
		return pUrlExpresion;
	}
	
	public ParserRule getUrlExpresionRule() {
		return getUrlExpresionAccess().getRule();
	}
