...
// Entry rule entryRuleAtributo2
entryRuleAtributo2 returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAtributo2Rule()); }
	iv_ruleAtributo2=ruleAtributo2
	{ $current=$iv_ruleAtributo2.current; }
	EOF;

// Rule Atributo2
ruleAtributo2 returns [EObject current=null]
@init {
	enterRule();
}
@after {
