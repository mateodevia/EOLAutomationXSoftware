...
class MyDslFormatter extends AbstractFormatter2 {
	...
	def dispatch void format(SimpleEntity simpleEntity, extension IFormattableDocument document) {
		// TODO: format HiddenRegions around keywords, attributes, cross references, etc. 
		for (AtributoSimple atributoSimple : simpleEntity.getAtributos()) {
			atributoSimple.format;
		}
	}
	
	// TODO: implement for MockarooEntity, ServicioRest, Test, Mapping, Asercion
}
